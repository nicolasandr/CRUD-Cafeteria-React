...
const CrearProductos = () => {
  ...
  const handleSubmit = (e)=>{
    e.preventDefault();
    //validar los datos
     if(cantidadCaracteres(nombreProdcuto)&& validarPrecio(precio) && validarURL(imagen) && validarCategoria(categoria)){
    ...
    <section className="container">
      ...
      <Form onSubmit={handleSubmit}>
        <Form.Group className="mb-3" controlId="formNombreProdcuto">
          ...
          <Form.Control type="text" placeholder="Ej: Cafe" onChange={e=>seTNombreProdcuto(e.target.value)} />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formPrecio">
          <Form.Label>Precio*</Form.Label>
          <Form.Control type="number" placeholder="Ej: 50" onChange={e=>setPrecio(e.target.value)} />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formPrecio">
